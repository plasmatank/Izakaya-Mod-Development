...
namespace RuntimeCloset
{
    ...
    public class Plugin : BasePlugin
    {
        ...
        public override void Load()
        {
            ...
            var cloest = new GameObject("ClosetInstance");
            cloest.AddComponent<RuntimeListener>();
            GameObject.DontDestroyOnLoad(cloest);
            cloest.hideFlags |= HideFlags.HideAndDontSave;
        }
    ...
    public class RuntimeListener : MonoBehaviour
    {
        ...
        {
            Object[] Sprites = RuntimeHelper.FindObjectsOfTypeAll(typeof(Sprite));
